...
def objectTracking(rawVideo):
    ...
    outputFrames = [list() for i in range(350)]
    minFeatureNum = 100
    mask = np.zeros_like(frames[0])

    for i in range(350):  # 100 frames
    ...
    imageio.mimwrite('Optical Flow Medium.mp4', outputFrames, fps=15)
    return


if __name__ == "__main__":
    rawVideo = cv2.VideoCapture('Medium.mp4')
